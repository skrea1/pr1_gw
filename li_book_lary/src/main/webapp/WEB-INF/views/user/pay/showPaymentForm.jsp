...
<table id="order_table">
	...
	<c:if test="${empty listBasket}">
		<tr>
			...
			<td><input type="number" id="0" name="number" min="0" max="500" step="1" value="1" onchange="changeTotal('0')"></td>
	...
	<c:if test="${not empty listBasket}">
		<c:forEach var="imsi" items="${listBasket}" varStatus="status">
			<tr>
				...
				<td><input type="number" id="${status.index + 1}" name="number" min="0" max="500" step="1" value="${imsi.basket_qry}" onchange="changeTotal('${status.index + 1}')"></td>
